...
export default function PaintingsFromYear({ params }: { params: { year: string }}) {
    ...
    <div className=" text-3xl flex gap-6 items-center min-h-screen justify-start md:px-10">
        ...
        {imgs.map((img, indx) => (
            <a className=" relative w-60 h-60 border border-white p-10 cursor-pointer hover:scale-105" key = {`${img} ${indx}`} href = {img}>
