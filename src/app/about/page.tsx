...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <Image src = '/about.jpg' width={220} height={220} alt = "Drawing for about page 2." />
...
export default function AboutPage() {
  ...
  function changeIndx(newIndx: number) {
    setCurrentIndex(newIndx)
    window.scrollTo({ top: 0, behavior: "smooth" })
  }

  return (
    <main className="min-h-screen bg-black flex flex-col items-center justify-start relative">
      <div className="w-full flex items-center justify-start md:-ml-12 bg-red-500">
         <Link href = '/' className="text-center w-full md:w-auto text-5xl hover:scale-105 font-martelSans text-white p-6 bg-main inline-block">
            WORDS FOR WEDNESDAY
        </Link>        
      </div>
            ...
            index === currentIndex && (
              ...
              >
                ...
                {section.backButtonLabel && (
                  <button
                    className="border border-white text-white px-6 py-3 mt-6 text-xl hover:bg-white hover:text-black transition"
                    onClick={() => changeIndx(currentIndex -1)}
                  >
                    {section.backButtonLabel}
                  </button>
                )}
